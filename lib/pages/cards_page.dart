...
//                   style: regularSFTextStyle(size: 24.sp, color: Colors.white),
//                 ),
//               ),
//               Container(
...
//                   style: regularSFTextStyle(size: 13.sp, color: Color(0xFFA0AEBB)),
//                 ),
//               ),
//               Container(
...
//                 child: InkWell(
//                     onTap: () {
//                       context.read(cardsViewModelProvider).navigateToScreen2();
//                     },
//                     child: Container(
...
//                                   style: regularSFTextStyle(size: 13.sp, color: Colors.white))),
//                           Image.asset(AppIcons.icArrow)
//                         ]))),
//               ),
//               Container(
//                 margin: EdgeInsets.only(left: 24.w, top: 16.h, right: 24.w, bottom: 30.h),
//                 height: 50.h,
//                 decoration: BoxDecoration(
//                     borderRadius: BorderRadius.circular(3.r),
//                     border: Border.all(
...
//                 child: InkWell(
//                     onTap: () {
//                       context.read(cardsViewModelProvider).navigateToComponentsPage();
//                     },
//                     child: Container(
//                         padding: EdgeInsets.only(left: 15.w, right: 15.w),
//                         child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
...
//           child: Text(_card.header, style: boldSFTextStyle(size: 24.sp, color: Colors.white))),
...
//                     style: regularSFTextStyle(size: 13.sp, color: Color(0xFFA0AEBB))),
//                 SizedBox(height: 7.h),
//                 Text('Euismod.', style: boldSFTextStyle(size: 14.sp, color: Colors.white))
//               ])),
...
//                       color:
//                           _indicatorCurrentIndex == index ? Color(0xFF0076CE) : Colors.transparent,
//                     ),
//                   );
//                 }).toList())
//               ],
...
//                         style: regularSFTextStyle(size: 56.sp, color: Colors.white),
//                       ),
//                     ),
//                     Container(
//                       padding: EdgeInsets.only(left: 24.w, top: 20.h),
//                       height: 298.h,
//                       child: Image.network(_card.images[imageIndex], fit: BoxFit.fill),
//                     ),
//                     Container(
...
//                       child: Text(
//                         _card.description,
//                         style: regularSFTextStyle(size: 14.sp, color: Color(0xFFA0AEBB)),
//                       ),
//                     ),
//                     Container(
...
//                         style: regularSFTextStyle(size: 13.sp, color: Color(0xFF67B4E0)),
//                       ),
//                     ),
//                   ]),
//                 ),
