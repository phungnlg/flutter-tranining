...
Future setupLocator() async {
  ...
  locator.registerLazySingleton<CardsRespository>(() => CardsRepositoryImpl(locator()));
  locator.registerFactory<IComponentsDataSource>(() => LocalComponentsDataSourceImpl());
  locator.registerLazySingleton<ComponentsRespository>(() => ComponentsRepositoryImpl(locator()));
...
void setupViewModels() {
  ...
  locator.registerFactory(() => CounterViewModel(locator(), locator()));
}
